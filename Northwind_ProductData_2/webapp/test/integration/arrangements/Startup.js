sap.ui.define([
	"sap/ui/test/Opa5",
	"northwind/Northwind_ProductData_2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("northwind.Northwind_ProductData_2.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "northwind.Northwind_ProductData_2",
					async: true
				},
				hash: oOptions.hash,
